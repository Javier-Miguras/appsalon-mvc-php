...
function seleccionarFecha(){
    ...
    inputFecha.addEventListener('input', (e) => {
        const dia = new Date(e.target.value).getUTCDay(); //getUTCDate indica el día
...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true){
    ...
    //Previene que se genera más de 1 alerta
...
function mostrarResumen(){
    ...
    const {nombre, fecha, hora, servicios} = cita; //destructuring de cita  
